 ...
 * @property {DateTime}  date       Base date. Only those units are significant which are covered by the `precision`
 *                                  member. As stated in
 *                                  https://moment.github.io/luxon/docs/manual/parsing.html#iso-8601,
 ...
 * @property {Precision} precision  Identifies which units are defined and which are omitted. For example, for `2016-05`
 *                                  the value will be `month`.
 */
